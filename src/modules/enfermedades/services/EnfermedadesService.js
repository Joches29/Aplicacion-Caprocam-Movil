...
async function getById(id) {
    try {
        ...
        throw construirErrorHttp(
            error,
            "Error al obtener la enfermedad."
        );
    }
}
...
async function getResumenDashboard(filtros = {}) {
    try {
        const response = await api.get("/enfermedades/resumen", {
            params: filtros,
        });
        ...
        throw construirErrorHttp(
            error,
            "Error al obtener el resumen de enfermedades."
        );
    }
}
...
async function getCatalogo() {
    try {
        ...
        throw construirErrorHttp(
            error,
            "Error al obtener el catalogo de enfermedades."
        );
    }
}
...
async function getCatalogoSeveridades() {
    try {
        ...
        throw construirErrorHttp(
            error,
            "Error al obtener el catalogo de severidades."
        );
    }
}
